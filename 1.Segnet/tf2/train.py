...
def parse_opt():
    ...
    parse.add_argument('--encoder_type',type=str,default='MobilenetV1_2',help='segnet模型编码器的类型[vgg16,MobilenetV1_1,MobilenetV1_2]')
...
if __name__ == '__main__':
    ...
    # 3.创建模型
    # 每5个epoch保存一次
    weight_path = 'weights/segnet_' + opt.encoder_type+'_weight/'
    model = build_segnet(opt.n_classes,opt.height,opt.width,opt.encoder_type)
